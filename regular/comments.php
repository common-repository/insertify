...
function icp_comments_func($atts){
        ...
        if($author != "nonexc"){
			...
			<table class="icp_table">
				<caption><?php esc_html_e('Author: ', 'insertify'); ?><?php echo $author;?> </caption>
                    <tr> <th><?php esc_html_e('Date & Time', 'insertify'); ?></th> <th><?php esc_html_e('Commented In', 'insertify'); ?></th> <th><?php esc_html_e('Comment', 'insertify'); ?></th> </tr> 
