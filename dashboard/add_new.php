...
function icp_add_new(){
    ...
    <br>
    <h1><center><?php esc_html_e('Add New', 'insertify'); ?></center></h1>
    <center><p><?php esc_html_e('Add entries here and access these from ', 'insertify');?><b><?php esc_html_e('Insertify >> Entries', 'insertify');?></b></p></center>
    <br>
    ...
    //Add Action Page
    if( isset($_REQUEST["ic_add_new_submit"]) ){
